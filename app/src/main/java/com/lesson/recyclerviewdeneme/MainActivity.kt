...
val sporListesi=ArrayList<String>()
        val sporList = ArrayList<String>()

        with(sporList) {
            add("Futbol Icerikleri")
            add("Basketbol Icerikleri")
            add("Tenis Icerikleri")
            add("Voleybol Icerikleri")
            add("Hentbol Icerikleri")
            add("Kayak Icerikleri")
            add("Yüzme Icerikleri")
        }


        val sporIcerigi = ArrayList<String>()
        sporIcerigi.add(
            "Futbol, on birer oyuncudan oluşan iki takım arasında, " +
        ...
        sporIcerigi.add(
            "Profesyonel basketbolda beşer kişilik iki takım, " +
        ...
        sporIcerigi.add(
            "Tenis, karşılıklı iki kişi ya da ikişer kişiden oluşan takımlarla, " +
        ...
        sporIcerigi.add(
            "Morgan tarafından 9 Şubat 1895'te tasarlandı. " +
        ...
        sporIcerigi.add(
            "Hentbolun amacı, takımınızla beraber uyum içinde çalışarak elinizdeki" +
        ...
        sporIcerigi.add(
            "Kayak sporu; Kar ve buz üzerinde kayarak yol almak için ayaklara takılan uzun ve yassı satıhlı," +
                    " ön uçları hafif yukarı ve arkaya kıvrık bir alet olan Kayak ile yapılan spor dalının adıdır."
        )
        sporIcerigi.add(
            "Yüzmenin en temel faydalarından birisi kas ve eklemlerin çalışmasını desteklemesidir. " +
        ...
        val adapter = RecyclerAdapter(sporList, sporIcerigi, sporGorselListesi)
